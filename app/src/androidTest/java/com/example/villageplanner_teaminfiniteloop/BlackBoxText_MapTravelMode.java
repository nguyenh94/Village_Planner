...
@LargeTest
public class BlackBoxText_MapTravelMode {
    ...
    @Test
    public void Test_MapTravelMode() throws InterruptedException {
        // Login.
        ...
        onView(withId(R.id.radio_walking)).perform(click());
        Thread.sleep(2000);

        //Check if the restaurant label is successfully displayed
        onView(withId(R.id.text_view_travelTimeLabel)).check(matches(isDisplayed()));
